...
const Footer = ()=>{
    return(
        <footer>
                <div className="body">
              <a href="https://drive.google.com/file/d/1tpKlP328bprspPcXxbtNdyz6J2rTHTL6/view?usp=sharing"><span className='linkCard'><img src="icons\curriculum.png" alt="Curriculum" /><p>CV</p></span></a>
