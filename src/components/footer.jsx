...
const Footer = ()=>{
    return(
        <footer>
                <div className="body">
              <a href="https://drive.google.com/file/d/1ZBlXp5DZF6yS1YykK6wDZ4HnIfoqfib7/view?usp=sharing"><span className='linkCard'><img src="icons\curriculum.png" alt="Curriculum" /><p>CV</p></span></a>
